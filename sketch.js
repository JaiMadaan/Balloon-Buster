...
var balloonSound,monster,monsterImg;
var score=0;
...
function preload(){
  ...
  monsterImg = loadImage("download.jpg")
...
background ("yellow")
 ...
 if (arrowGroup.isTouching(monsterGroup)){  arrowGroup.destroyEach();
...
function monster(){
  var monster = createSprite(0,Math.round(random(20,300)),10,10)
